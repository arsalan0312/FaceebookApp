...
using Owin;
using FacebookTestingApp.Models;
...
namespace FacebookTestingApp
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            var facebookOption = new Microsoft.Owin.Security.Facebook.FacebookAuthenticationOptions
            {
            ...
            facebookOption.Scope.Add("email user_friends user_about_me user_birthday user_location");
